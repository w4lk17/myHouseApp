...
class CartController extends GetxController {
  ...
  void addToCart(ProductModel product) {
    ...
    if (productQuantityInCart.value < 1) {
      TLoaders.customToast(message: 'Please select a quantity.');
      return;
    }
    ...
    if (product.productType == ProductType.variable.toString() &&
      ...
      TLoaders.customToast(message: 'Please select a variation.');
      return;
    }
    ...
    // convert the productModel to CartItemModel with thw given quantity
  ...
  void removeOneFromCart(CartItemModel item) {
    ...
    if (index >= 0) {
      if (cartItems[index].quantity > 1) {
        ...
        // show dialog before completely removing the item
