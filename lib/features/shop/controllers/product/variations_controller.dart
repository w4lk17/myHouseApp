...
import 'package:my_house/features/shop/controllers/product/images_controller.dart';
import 'package:my_house/features/shop/models/product_model.dart';
import 'package:my_house/features/shop/models/product_variation_model.dart';
...
class VariationsController extends GetxController {
  ...
  /// selected attributs,and variation
  void onAttributeSelected(ProductModel product, attributeName, attributeValue) {
    // when attribute is selected we will first add that attribute to selectedAttribute
    ...
    // update selected products variation status
